      ...
      <div class="center-box" v-if="show">
        <el-row :gutter="20">
          <el-col :span="18">
            <div class="left-box">
              <el-row>
                <el-col :span="4" class="left-box-head"
                  ><div
                ...
                >
                <el-input
                  style="float:right;width:200px;margin-top:15px;margin-right:20px"
                  ...
                  >
                    <template slot-scope="scope">
                      <el-button
                        size="mini"
                        type="info"
                        v-if="scope.row.difficulty === 'Casual'"
                        >Casual</el-button
                      >
                      <el-button
                        size="mini"
                        type="success"
                        v-if="scope.row.difficulty === 'Eazy'"
                        >Eazy</el-button
                      >
                      <el-button
                        size="mini"
                        type="primary"
                        v-if="scope.row.difficulty === 'Normal'"
                        >Normal</el-button
                      >
                      <el-button
                        size="mini"
                        type="warning"
                        v-if="scope.row.difficulty === 'Hard'"
                        >Hard</el-button
                      >
                      <el-button
                        size="mini"
                        type="danger"
                        v-if="scope.row.difficulty === 'Crazy'"
                        >Crazy</el-button
                      >
                      <!-- <el-button
          ...
          <el-col :span="6">
            <div class="right-box" style="min-height:100px">
              ...
              <el-row
                style="width:96%;margin-left:4%;margin-top:-20px;min-height:30px"
...
export default {
  ...
  methods: {
    ...
    goto(id) {
      this.$router.push({ path: '/practice/answer', query: { id: id } });
    },
    async queryList() {
      this.practiseListLoading = true;
      this.params_init();
      try {
         const {data:res1} = await this.$http.post('/practice/getCount', {
          page: this.page,
        ...
        const {data:res} = await this.$http.post('/practice/getAll', {
          page: this.page,
          difficulty: this.difficulty,
          tid: this.tid,
          keywords: this.keywords
