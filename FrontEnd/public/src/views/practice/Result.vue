            ...
            <div class="center-box" v-if="show">
                ...
                <el-row style="background-color:#ffffff;margin-top:20px;border-radius: 4px;overflow: hidden;">
                    <el-row>
                        ...
                        <span style="font-size:20px;margin-top:15px;margin-left:20px;float:left"
                              v-if="option">Code</span>
                        <el-switch style="display: block;float:right;margin-top:15px;margin-right:2%;" v-model="option"
                                   active-color="#409eff" inactive-color="#409eff" :active-value="true"
                                ...
                                <el-form label-position="left" inline class="demo-table-expand">
                                    ...
                                    <el-form-item label="Output:">
                                        <span style="white-space: pre-wrap;"
                                              v-html="props.row.realOutput.replaceAll('\n','<br>')"></span>
                                    </el-form-item>
                                    <el-form-item v-if="props.row.errorOutput" label="ErrorOutput:">
                                        <span style="white-space: pre-wrap;"
                                              v-html="props.row.errorOutput.replaceAll('\n','<br>')"></span>
                                    </el-form-item>
                                </el-form>
                            </template>
                        </el-table-column>
