                ...
                <el-row :gutter="20">
                    <el-col :span="18">
                        <div class="left-box">
                            <el-row>
                                <div
                                    style="text-align:center;font-size:20px;line-height:20px;float:left;margin-left:20px">
                                    <p>Problem List</p>
                                </div>
                                ...
                                <el-select v-model="difficulty" placeholder="Difficulty"
                                           style="margin-top:15px;margin-right:20px;float:right;width:140px"
                                           size="small"
                                ...
                                <el-table :highlight-current-row="true" size="small" :data="problemList"
                                    ...
                                    <el-table-column v-if="hasFlag" align="center" label="" width="50">
                                        <template slot-scope="scope">
                                            ...
                                            <i class="el-icon-minus" style="color:#F56C6C;font-size:20px;margin-top:2px"
                                               v-if="scope.row.flag !== 'AC' && scope.row.flag !== ''"></i>
                                        </template>
                                    </el-table-column>
                                    ...
                                    <el-table-column prop="difficulty" align="center" label="Level" min-width="80">
                                        <template slot-scope="scope">
                                            <el-button size="mini" type="info" v-if="scope.row.difficulty === 'Casual'">
                                                Casual
                                            </el-button>
                                            <el-button size="mini" type="success"
                                                       v-if="scope.row.difficulty === 'Easy'">Easy
                                            </el-button>
                                            <el-button size="mini" type="primary"
                                                       v-if="scope.row.difficulty === 'Normal'">Normal
                                            </el-button>
                                            <el-button size="mini" type="warning"
                                                       v-if="scope.row.difficulty === 'Hard'">Hard
                                            </el-button>
                                            <el-button size="mini" type="danger"
                                                       v-if="scope.row.difficulty === 'Crazy'">Crazy
                                            </el-button>
                                        </template>
                                    </el-table-column>
                                    ...
                                    <el-table-column v-if="realShowTags" prop="tags" align="center" label="Tags"
                                                     min-width="120">
                                        <template slot-scope="scope">
                    ...
                    <el-col :span="6">
                        <div class="right-box" style="min-height:100px">
                            ...
                            <el-row style="width:96%;margin-left:4%;margin-top:-20px;min-height:30px"
                                    v-loading="tagsLoading">
                                <el-button round size="small" class="tag-btn" v-bind:key="index"
...
export default {
    ...
    async mounted() {
        ...
        try {
            const {data: res} = await this.$http.post('/practice/getTags');
            if (res.error) {
