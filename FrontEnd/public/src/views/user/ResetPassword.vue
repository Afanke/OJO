        ...
        <transition name="slide-fade">
          <div class="inner-box" v-if="c === 1">
            ...
            <el-form label-position="left" :rules="rule1" style="width:80%;margin:40px auto" :model="form1">
              ...
              <el-form-item>
                <el-button @click="sendEmail" :loading="loading" style="width: 100%" type="primary">Next Step</el-button>
              </el-form-item>
            </el-form>
...
<!--              <el-button style="float:right">Resend</el-button>-->
            ...
            <el-button @click="sendVCode" :loading="loading"  style="width: 80%;margin-left:10%;margin-top:20px;margin-bottom:30px" type="primary">
              Next Step
            </el-button>
          </div>
        </transition>
        <transition name="slide-fade">
          <div class="inner-box" v-if="c === 3">
            ...
            <el-form label-position="left" style="width:80%;margin:40px auto" :rules="rule2" :model="form2">
              ...
              <el-form-item>
                <el-button @click="sendPassword" :loading="loading"  style="width: 100%" type="primary">Next Step</el-button>
              </el-form-item>
            </el-form>
            <div style="height: 10px;margin-top:10px"></div>
          </div>
    ...
    return {
      ...
      rule2: {
        password: [
          ...
          {min: 8, max: 32, required: true, message: 'The length of password must between 8 and 32', trigger: 'blur'},
        ],
        password2: [
