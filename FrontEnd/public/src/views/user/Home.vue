<template>
  ...
  <div>
    <transition name="slide-fade">
      <div v-if="show">
        <div class="avatar">
          <el-avatar icon="el-icon-user-solid" :size="140" :src="this.$http.defaults.baseURL+detail.iconPath"></el-avatar>
        </div>
        <div class="center-box">
          ...
          <el-row style="width:70%;margin-left:15%;margin-top:20px;text-align:center">
            <el-button size="small" @click="gotoProblem(item)" v-for="(item,index) in stat.solvedList" :key="index">
              {{put0(item)}}</el-button>
          </el-row>
          <el-row style="text-align:center;margin-top:30px">
            ...
            <img @click="copyEmail" style="width:30px;cursor:pointer" src="../../assets/images/email.svg" alt="">
