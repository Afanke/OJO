        ...
        <div class="right-box">
          <transition name="slide-fade">
            <div v-if="c === 1">
              ...
              <el-row v-if="showCropper" style="margin-top:20px">
                <el-col :span="12" class="cropper-content">
                  <div class="cropper" style="display:flex">
                    <vueCropper ref="cropper" style="float:left" :img="option.img" :outputSize="option.size"
                    ...
                    <div style="flex:1;margin-left:20px;">
                      <div style="position:relative;top:50%;transform:translateY(-50%);">
                        ...
                        <div>
                          <el-button type="primary" icon="el-icon-refresh-right" @click="rotateRight" class="btn">
                          </el-button>
                        </div>
                        <div>
                          <el-button type="primary" icon="el-icon-close" @click="close" class="btn"></el-button>
                        </div>
                        <div>
                          <el-button type="primary" icon="el-icon-check" @click="beforeUpload" class="btn"></el-button>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <el-button type="primary" size="small" style="margin:30px 0px" @click="saveProfile">Save All</el-button>
              ...
              <div style="display:flex">
                <div style="flex:1;border-right:1px dotted #DCDFE6">
                  ...
                  <el-row style="margin-top:20px;margin-right:40px">
                    <div class="input-label"><span style="color:red">*&nbsp;</span>Current Password</div>
                    <el-input size="small" v-model="curPassword" show-password>
                    </el-input>
                    <div class="input-label" style="margin-top:20px"><span style="color:red">*&nbsp;</span>New Password
                    </div>
                    <el-input size="small" v-model="newPassword" show-password>
                    </el-input>
                    <div class="input-label" style="margin-top:20px"><span style="color:red">*&nbsp;</span>Confirm New
                      Password</div>
                    <el-input size="small" v-model="newPassword1" show-password>
                    </el-input>
                  </el-row>
                  <el-button @click="savePassword" type="primary" size="small" style="margin:30px 0px">Update Password</el-button>
                </div>
                <div style="flex:1;">
                  <el-row style="margin-left:40px">
                    ...
                    <el-row style="margin-top:20px;margin-right:10px">
                      ...
                      <div class="input-label" style="margin-top:20px"><span style="color:red">*&nbsp;</span>New Email
                      </div>
                      <el-input size="small" v-model="newEmail">
                      </el-input>
                    </el-row>
                    <el-button @click="saveEmail" type="primary" size="small" style="margin:30px 0px">Update Email</el-button>
                  </el-row>
                </div>
              </div>
            </div>
