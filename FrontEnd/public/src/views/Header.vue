<template>
    <div>
        <el-row class="tac">
            <el-menu ref="MenuRef" :default-active="activeIndex" class="el-menu-demo" mode="horizontal"
                     text-color="#545c64"
        ...
        <el-drawer title="Login" :visible.sync="loginDrawer" :before-close="handleClose" :with-header="false"
                   size="450px">
            <el-form label-width="20%" :model="loginForm" v-loading="loginLoading" ref="loginFormRef"
                     :rules="loginRules"
                     status-icon>
                ...
                <el-form-item prop="password">
                    <el-input v-model="loginForm.password" prefix-icon="el-icon-lock" style="width:80%" show-password
                              clearable
                              placeholder="Password"></el-input>
                </el-form-item>
                <el-form-item prop="captcha">
                    <el-col :span="11">
                        <el-input v-model="loginForm.captcha" prefix-icon="el-icon-view" clearable
                ...
                <el-form-item label="">
                    <div style="width:80%">
                        <el-link type="primary" style="float:left;margin-top:-20px" @click="registerDrawer=true">Go to
                            register!
                        </el-link>
        ...
        <el-drawer title="Register" :visible.sync="registerDrawer" :before-close="handleClose" :with-header="false"
            ...
            <el-form label-width="20%" :model="registerForm" v-loading="registerLoading" ref="registerFormRef"
                ...
                <el-form-item label="" prop="password">
                    <el-input v-model="registerForm.password" prefix-icon="el-icon-lock" style="width:80%" show-password
                              clearable
                              placeholder="Password"></el-input>
                </el-form-item>
                <el-form-item label="" prop="passwordAgain">
                    <el-input v-model="registerForm.passwordAgain" prefix-icon="el-icon-lock" style="width:80%"
                              show-password
                              clearable placeholder="Password Again"></el-input>
                </el-form-item>
                <el-form-item label="" prop="captcha">
                    <el-col :span="11">
                        <el-input v-model="registerForm.captcha" prefix-icon="el-icon-view" clearable
                                  placeholder="Captcha">
                        </el-input>
                    </el-col>
                    <el-col class="line" :span="7">
