                ...
                <div class="left-box">
                    ...
                    <el-row style="text-align:left;" class="answer-box">
                        ...
                        <el-row style="width:95%;margin:15px auto 15px">
                            ...
                            <span style="float: right;margin:10px 20px 0 0;font-size:14px;color:gray"
                                  v-if="submitLimit">Submit Limit:&nbsp;{{ submitNumber }} / {{ submitLimit }}</span>
                        </el-row>
                    </el-row>
                </div>
                <div class="right-box">
