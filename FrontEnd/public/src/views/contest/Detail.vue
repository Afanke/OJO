            ...
            <div v-if="c === 1">
              <div class="inner-box" v-loading="loading">
                <el-row style="height:65px;line-height:65px">
                  <span style="font-size:23px;float:left;margin-left:30px">{{
                    title
                  }}</span>
                ...
                <el-row
                  style="font-size:18px;padding-left:30px;margin-bottom:30px"
                >
                  {{ description }}
                </el-row>
                ...
                <el-table :data="contestData" style="width: 100%" size="mini">
                  <el-table-column
                    prop="startTime"
                    label="Start Time"
                    min-width="180"
                  ...
                  <el-table-column prop="rule" label="Rule" min-width="180">
                  </el-table-column>
                  <el-table-column
                    prop="creator"
                    label="Creator"
