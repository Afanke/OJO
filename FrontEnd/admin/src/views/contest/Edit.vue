                    ...
                    <el-row :gutter="20" style="margin-top:40px">
                        <el-col :span="7" style="padding-top:3px">
                            ...
                            <el-row class="small-element" style="margin-top:30px;margin-left:10px">
                                <el-radio v-model="rule" label="OI" disabled>OI</el-radio>
                                <el-radio v-model="rule" label="ACM" disabled>ACM</el-radio>
                            </el-row>
                        </el-col>
                        ...
                        <el-col :span="7" :offset="1">
                            ...
                            <el-row class="small-element">
                                <el-input-number :disabled="isStarted" v-model="submitLimit" controls-position="right"
