            ...
            <div class="center-box" v-if="show">
                ...
                <el-table :data="tableData" style="width: 100%" v-loading="loading" size="small">
                    ...
                    <el-table-column align="center" label="Status" min-width="60">
                        <template slot-scope="scope">
                            <el-button size="mini" type="primary" v-if="scope.row.status === 'Not Started'" plain="">Not
                                Started
                            </el-button>
                            <el-button size="mini" type="success" v-if="scope.row.status === 'Under Way'" plain="">Under
                                Way
                            </el-button>
                            <el-button size="mini" type="danger" v-if="scope.row.status === 'Ended'" plain="">Ended
                            </el-button>
                        </template>
                    </el-table-column>
                            ...
                            <el-row>
                                <el-tooltip content="Edit" placement="top">
                                    <el-button size="mini" class="el-icon-edit-outline"
                                               @click="editContest(scope.row.id)"></el-button>
                                </el-tooltip>
                                <el-tooltip content="Problem List" placement="top">
                                    <el-button size="mini" class="el-icon-notebook-2"
                                               @click="editProblem(scope.row.id)"></el-button>
                                </el-tooltip>
                                <el-tooltip content="Download Submissions" placement="top">
                                    <el-button size="mini" class="el-icon-download"
                                               @click="getAllSubmission(scope.row.id)"></el-button>
                                </el-tooltip>
