            ...
            <div class="center-box" v-if="show">
                ...
                <el-row style="margin-top:20px;">
                    <el-button type="primary" @click="goImport" size="small" class="el-icon-plus"
                               style="margin-left:30px;float:left">&nbsp;Import
                    </el-button>
                </el-row>
                <el-row style="margin-top:20px;">
                </el-row>
                <el-dialog title="Import From Available Problem" :visible.sync="dialogVisible" class="dialog"
                           width="1000px">
                    <el-table :data="tableData2" style="margin-top:-25px" v-loading="loading2">
                        ...
                        <el-table-column label="Creator" min-width="30" prop="creatorName"
                            ...
                            <template slot-scope="scope">
                                <el-row>
                                    <el-tooltip content="Add" placement="top">
                                        <el-button size="mini" class="el-icon-plus" @click="addProblem(scope.row.id)"
                                                   :disabled="isInList(scope.row.id)"></el-button>
                                    </el-tooltip>
                                </el-row>
                            </template>
                        </el-table-column>
    ...
    methods: {
        ...
        async addProblem(pid) {
            try {
                ...
                await this.queryCtsPb()
                await this.queryAvaPb()
