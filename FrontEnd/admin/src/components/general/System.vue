      ...
      <div v-if="show">
        <div class="content">
          ...
          <el-row style="margin-top:10px">
            <el-button style="float:left;margin-left:30px;margin-top:10px" type="primary" @click="saveSMTP">Save</el-button>
          </el-row>
        ...
        <div class="content" style="margin-top:20px">
          ...
          <el-row :gutter="20" style="margin-top:20px;margin-left:20px;margin-right:20px">
            ...
            <el-col :span="21">
              <el-input type="textarea" resize="none" :autosize="{ minRows: 2}" placeholder="<a href='xxx'>Footer</a>"
                v-model="Web.footer">
              </el-input>
            </el-col>
          </el-row>
          ...
          <el-row style="margin-top:10px">
            <el-button @click="saveWeb" style="float:left;margin-left:30px;margin-top:10px" type="primary">Save</el-button>
          </el-row>
          <el-row style="height:20px">
          </el-row>
        </div>
